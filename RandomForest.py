...
master_path = r'C:InsertFileLocation.csv'
example_path = r'C:InsertFileLocation.csv'
...
def log_reg_holdout():
    ...
    x1 = bots_humans.drop(['label', 'financial', 'self-declared', 'fake_follower', 'CAP'], axis=1).values
    y1 = bots_humans['label'].values
...
def log_reg_holdout_save_model(model_name):
    ...
    # split into array for the features and resp vars
    x1 = bots_humans.drop('label', axis=1).values
    y1 = bots_humans['label'].values
...
def holdout_all_classifiers_pruned():
    ...
    # split into array for the features and resp vars
    removed = ['label', 'financial', 'self-declared', 'fake_follower', 'CAP']
    x1 = bots_humans.drop(['label','id'], axis=1).values
    # print(bots_humans.drop(['labels', 'id'], axis=1).head(5))
    # return
    y1 = bots_humans['label'].values
